...
class DeepintCredentialsError(DeepintBaseError):
    ...
    def __init__(self):
        super().__init__(code="CREDENTIALS_NOT_FOUND",
                         message="Unable to load credentials from file, env or parameter")
...
class DeepintTaskError(DeepintBaseError):
    ...
    def __init__(self, task: str, name: str, code: str, message: str) -> None:
        super().__init__(
            code=f"TASK_{code}", message=f"Task ({task}) {name} failed with description: {message}")
